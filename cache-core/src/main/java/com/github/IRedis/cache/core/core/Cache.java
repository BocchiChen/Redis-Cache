...
import com.github.IRedis.cache.core.persist.InnerCachePersist;
import com.github.IRedis.cache.core.proxy.CacheProxy;
import com.github.IRedis.cache.core.support.evict.CacheEvictContext;
...
public class Cache<K,V> implements ICache<K,V> {
    ...
    public V put(K key, V value) {
        ...
        // 添加拦截器调用
        if (!ObjectUtil.isNull(evictEntry)) {
            // 执行淘汰监听器
